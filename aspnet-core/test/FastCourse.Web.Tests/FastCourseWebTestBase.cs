...
{
    public abstract class FastCourseWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static FastCourseWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(FastCourseWebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<FastCourseDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<FastCourseDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<FastCourseDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<FastCourseDbContext, Task<T>> func)
        {
            T result;
