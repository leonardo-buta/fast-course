...
namespace FastCourse.EntityFrameworkCore.Seed.Host
{
    public class DefaultLanguagesCreator
    {
        public static List<ApplicationLanguage> InitialLanguages => GetInitialLanguages();

        private readonly FastCourseDbContext _context;

        private static List<ApplicationLanguage> GetInitialLanguages()
        {
            var tenantId = FastCourseConsts.MultiTenancyEnabled ? null : (int?)MultiTenancyConsts.DefaultTenantId;
        ...
        public DefaultLanguagesCreator(FastCourseDbContext context)
        {
            _context = context;
        }
