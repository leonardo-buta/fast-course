        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_CertificateEmission_AbpUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AbpUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_CertificateEmission_Certificate_CertificateId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_VideoLessonUserProgress", x => x.Id);
                    table.ForeignKey(
                        name: "FK_VideoLessonUserProgress_AbpUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AbpUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_VideoLessonUserProgress_VideoLesson_VideoLessonId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CertificateEmission_CertificateId",
                table: "CertificateEmission",
                column: "CertificateId");

            migrationBuilder.CreateIndex(
                name: "IX_CertificateEmission_UserId",
                table: "CertificateEmission",
                column: "UserId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_VideoLessonUserProgress_UserId",
                table: "VideoLessonUserProgress",
                column: "UserId");

            migrationBuilder.CreateIndex(
                name: "IX_VideoLessonUserProgress_VideoLessonId",
                table: "VideoLessonUserProgress",
