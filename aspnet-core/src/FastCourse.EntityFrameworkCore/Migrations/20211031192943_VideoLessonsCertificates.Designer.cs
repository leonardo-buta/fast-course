...
namespace FastCourse.Migrations
{
    ...
    [Migration("20211031192943_VideoLessonsCertificates")]
    partial class VideoLessonsCertificates
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("FastCourse.Courses.Course", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("FastCourse.QuestionAlternatives.QuestionAlternative", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.ToTable("QuestionAlternative");
                });

            modelBuilder.Entity("FastCourse.Questions.Question", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("FastCourse.VideoLessons.VideoLesson", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Abp.Authorization.Roles.RoleClaim", b =>
                {
                    b.HasOne("FastCourse.Authorization.Roles.Role", null)
                        .WithMany("Claims")
            ...
            modelBuilder.Entity("Abp.Authorization.Users.UserClaim", b =>
                {
                    b.HasOne("FastCourse.Authorization.Users.User", null)
                        .WithMany("Claims")
            ...
            modelBuilder.Entity("FastCourse.QuestionAlternatives.QuestionAlternative", b =>
                {
                    b.HasOne("FastCourse.Questions.Question", "Question")
            ...
            modelBuilder.Entity("FastCourse.Questions.Question", b =>
                {
                    b.HasOne("FastCourse.Courses.Course", "Course")
                        .WithMany()
